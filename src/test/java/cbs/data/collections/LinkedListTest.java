...
import cbs.data.collections.LinkedList;
...
public class LinkedListTest {
    ...
    private static void print(final String mess, final LinkedList<?> list){
    ...
    private static Stream<Arguments> testAppendArguments(){
        return Stream.of(
            ...
            Arguments.of((Object)LinkedListTest.dataToArray()),
    ...
    void testGetAt(int index, final String expected) {
        LinkedList<String> test = this.newList();
    ...
    public LinkedList<String> removeList(){
        LinkedList<String> test = new LinkedList<>();
        test.append(DATA_0);
        test.append(DATA_0);
        test.append(DATA_1);
    ...
    void testRemoveAll(final String data, int expectedCount, int firstIndex) {
        LinkedList<String> test = this.removeList();
        printSep();
        print("Original", test);
        test.removeAll(data);
